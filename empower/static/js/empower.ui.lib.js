    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var stream in data) {
                ...
                wtpField.innerHTML = data[stream].wtp.addr + " (" + data[stream].wtp.supports[0].channel + ", " + data[stream].wtp.supports[0].band + ")"
                ...
                if (tenant) {
                    wtpCtrl.innerHTML = "<a href=\"#\" onClick=\"listWTPs('" + data[stream].addr + "','" + data[stream].wtp.supports[0].addr + "', '" + tenant + "')\"><img width=\"24\" src=\"/static/images/edit.png\" /></a>"
                } else {
                    wtpCtrl.innerHTML = "<a href=\"#\" onClick=\"listWTPs('" + data[stream].addr + "','" + data[stream].wtp.supports[0].addr + "')\"><img width=\"24\" src=\"/static/images/edit.png\" /></a>"
                }
            }
        },
    });
